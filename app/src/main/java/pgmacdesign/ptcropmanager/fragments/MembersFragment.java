...
public class MembersFragment extends ParentFragment  {

    //region Static Vars

    private static final Constants.AllFragments THIS_FRAGMENT =
            Constants.AllFragments.MembersFragment;
    private static final int LAYOUT_RES_ID = R.layout.members_fragment;
