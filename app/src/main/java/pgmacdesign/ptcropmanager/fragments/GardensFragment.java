...
public class GardensFragment extends ParentFragment  {

    //region Static Vars

    private static final Constants.AllFragments THIS_FRAGMENT =
            Constants.AllFragments.GardensFragment;
    private static final int LAYOUT_RES_ID = R.layout.gardens_fragment;
